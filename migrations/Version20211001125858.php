 ...
 */
final class Version20211001125858 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE company (id INT AUTO_INCREMENT NOT NULL, supervisor_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_4FBF094F19E9AC5F (supervisor_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE company ADD CONSTRAINT FK_4FBF094F19E9AC5F FOREIGN KEY (supervisor_id) REFERENCES user (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE company DROP FOREIGN KEY FK_4FBF094F19E9AC5F');
